  ...
  render() {
    ...
    return (
      <header id="home" style={{ height: window.innerHeight - 500, display: 'block' }}>
        <a href="https://github.com/raj1vsr1vastava" target="_blank" rel="noreferrer" className="github-corner" aria-label="View source on GitHub">
        ...
        <Nav activeKey="/home" fill style={{ position: 'absolute', top: 10, right: 10 }}>
          ...
          <Nav.Item>        
            <LinkContainer to="/about">
              <Nav.Link eventKey="about">Skills</Nav.Link>
            </LinkContainer>
          </Nav.Item> */}
          <Nav.Item>
            <Switch 
